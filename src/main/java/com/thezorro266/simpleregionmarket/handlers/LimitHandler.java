...
public class LimitHandler {
	...
	private HashMap<String, Object> limitEntries = new HashMap<String, Object>();
	...
	public int countPlayerChildRegions(Player player, TemplateMain token, ProtectedRegion parentRegion) {
		...
		langHandler.outputConsole(Level.INFO, "Counting " + count + " regions for player " + player.getName() + " for parent region "+parentRegion.getId()+" on template " + token.id + ".");
		return count;
	}
	...
	public int countPlayerWorldRegions(Player player, TemplateMain token, String world) {
		...
		langHandler.outputConsole(Level.INFO, "Counting " + count + " regions for player " + player.getName() + " in world "+world+" on template " + token.id + ".");
		return count;
	}
